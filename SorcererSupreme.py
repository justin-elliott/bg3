#!/usr/bin/env python3
"""
Generates files for the "SorcererSupreme" mod.
"""
...
from modtools.replacers import Replacer, spell_list
from uuid import UUID


class SorcererSupreme(Replacer):
    def __init__(self):
    ...
    @spell_list("485a68b4-c678-4888-be63-4a702efbe391")  # Sorcerer Cantrips
    def cantrips(self, spell_list: SpellList) -> None:
        pass


def main():
    sorcerer_supreme = SorcererSupreme()
    sorcerer_supreme.build()
